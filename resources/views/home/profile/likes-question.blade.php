...
@section('content')
    ...
    <div class="mt-4 row">
        ...
        <div class="col-md-10 col-12 likes-question-box">
            <div class="col-md-12 col-12">
                <h5>Likes Question</h5>
                <div class="card">
                    <div class="card-body pt-0">

                        @if ($likesQuestion->first() == null)
                            <p class="m-0">Don't have likes question record yet.</p>
                        @endif
                        @foreach ($likesQuestion as $question)
                            <div class="user-likes-question row">
                                <div class="col-md-9 col-8">
                                    ...
                                    <a href="{{ route('question.show', [$question->question->id, $question->question->slug]) }}">{{ $question->question->title }}</a>
                                </div>
