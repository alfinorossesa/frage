...
@section('content')
    <div class="d-flex justify-content-center report-box">
        <div class="col-md-7">
            <h6 class="text-danger mb-3"><i class="fa-solid fa-flag"></i> Report this question!</h6>
            <div class="card report">
                <div class="card-body">
                    <p class="text-danger">Please tell us why you report this question.</p>
                    <form action="{{ route('question.reportStore', [$question->id, $question->slug]) }}" method="POST" class="mt-3">
                        @csrf
                        <div class="mb-3">
